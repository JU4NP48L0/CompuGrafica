...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Creacion Piramide 1 rojo superior
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 rojo inferior medio
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 rojo inferior izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 4 rojo inferior derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 5 rojo medio derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 6 rojo medio izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 azul superior
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 azul inferior medio
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 azul inferior izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 4 azul inferior derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 5 azul medio derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 6 azul medio izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 verde superior
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 verde inferior medio
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 verde inferior izquieda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 4 verde inferior derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 5 verde medio izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 6 verde medio derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide Principal suelo
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 amarillo centro
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 amarillo superior centro
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 amarillo superior derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 4 amarillo superior izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 5 amarillo centro izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 6 amarillo centro derecha
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 rojo medio invertido
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 rojo inferior derecha invertido
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 rojo inferior izquierda invertido
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 verde medio invertida
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 verde inferior izquierda invertida
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 verde inferior derecha invertida
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 azul medio rotada
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 azul inferior izquierda rotada
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 3 azul inferior derecha rotada
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 1 amarillo centro relleno
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.2f, -0.5f, -3.7f));
		...
		//Creacion Piramide 2 amarillo superior centro relleno
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.28f, -0.5f, -4.5f));
		model = glm::scale(model, glm::vec3(0.12f, -0.05f, 0.12f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//Creacion Piramide 3 amarillo superior derecha relleno
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.65f, -0.5f, -3.96f));
		model = glm::scale(model, glm::vec3(0.12f, -0.05f, 0.12f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//Creacion Piramide 4 amarillo superior izquierda relleno
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.27f, -0.5f, -3.45f));
		model = glm::scale(model, glm::vec3(0.12f, -0.05f, 0.12f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//Creacion Piramide 6 amarillo centro derecha relleno
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.2f, -0.5f, -4.22f));
		model = glm::scale(model, glm::vec3(0.12f, -0.05f, 0.12f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//Creacion Piramide 1 amarillo superior izquierda
		model = glm::mat4(1.0);
		...
		//Creacion Piramide 2 amarillo centro
		model = glm::mat4(1.0);
