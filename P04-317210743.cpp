...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux9(1.0);
	glm::mat4 modelaux10(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(4.0f, 11.0f, 4.0f));
		...
		//ojo1 reticula
		model = glm::translate(model, glm::vec3(-9.3f, 2.9f, 1.25f));
		...
		//oreja 1
		model = glm::translate(model, glm::vec3(-7.0f, 4.3f, -2.4f));
		...
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(10.0f, 3.0f, 5.0f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//color = glm::vec3(0.0f, 0.5f, 0.0f);
		...
		//model = glm::scale(model, glm::vec3(10.0f, 3.0f, 6.0f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
